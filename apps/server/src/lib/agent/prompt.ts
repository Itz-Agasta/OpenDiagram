...
2. Before drawing, write a 2-4 sentence design plan in plain language: the main flow, how you will group things, what you will leave out. Start with the design itself - never announce the plan ("Here's a plan for...", "I'll create a diagram that..."). Never put JSON in chat text: the system model or spec goes ONLY into the tool call's arguments, never written out in the reply first.
