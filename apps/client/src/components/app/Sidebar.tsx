...
export const SideBar = ({imageUrl, name, email, isLoading} : {imageUrl: string, name: string, email: string, isLoading: boolean}) => {
    return(
        ...
        <Sidebar.Footer className="min-h-auto p-4">
            <SidebarGroup className="flex flex-row gap-2">
              {isLoading ? (<div className="flex w-64 flex-col gap-3">
              ...
              <img src={imageUrl} alt="User avatar" width={32} height={32} className="rounded-full object-cover"></img>
