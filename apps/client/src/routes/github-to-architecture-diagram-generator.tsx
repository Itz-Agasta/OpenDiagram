...
export const Route = createFileRoute("/github-to-architecture-diagram-generator")({
  head: () => ({
    meta: [
  ...
  component: GitHubToArchitectureDiagramGeneratorPage,
});

function GitHubToArchitectureDiagramGeneratorPage() {
  return (
    <MarketingPage>
