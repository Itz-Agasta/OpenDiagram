...
import { MarketingButton, CustomButton } from "#/components/ui/button";
...
export const Route = createFileRoute("/ai-diagram-generator")({
  head: () => ({
    meta: [
  ...
  component: AIArchitectureDiagramGeneratorPage,
});

function AIArchitectureDiagramGeneratorPage() {
  return (
    <MarketingPage>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <Link to="/features">
                  <CustomButton
                    ...
                    className="h-9 px-6 rounded-xl text-[14px]"
                  />
                </Link>
              </div>
            </div>
