/**
 * Lightweight SVG "diagram" thumbnails rendered as black line art on paper,
 * matching OpenDiagram's technical/editorial brand. Five variants.
 */
type Variant = "flow" | "sequence" | "cloud" | "erd" | "mindmap";
...
export function DiagramThumb({ variant }: { variant: Variant }) {
  ...
  return (
    <div className="h-full w-full bg-[var(--od-surface)] p-4">
      <Comp />
    </div>
  );
}
